 ...
 * @author Shameera
 */
@WebServlet(urlPatterns = {"/AddBookingUser"})
public class AddBookingUserServlet extends HttpServlet {

    private static final long serialVersionUID = 1L;

    public AddBookingUserServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/asUser/bookingFormUser.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (errorString != null) {
            RequestDispatcher dispatcher = request.getServletContext()
                    .getRequestDispatcher("/bookingForm.jsp");
            dispatcher.forward(request, response);
        } // If everything nice.
