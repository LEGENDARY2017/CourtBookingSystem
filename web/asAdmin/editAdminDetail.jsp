                            ...
                            <form action="${pageContext.request.contextPath}/EditAdmin" method="post">
                                ...
                                <div class="row uniform">
                                    ...
                                    <div class="6u 12u(xsmall)">
                                        ...
                                        <input type="text" name="name" id="name" class="col-sm-sm" value="${admin.name}" disabled/>
                                    </div>
                                ...
                                <div class="12u">
                                    <ul class="actions">
                                        ...
                                        <li><a href="${pageContext.request.contextPath}/adminList" class="button fit special">Cancel</a></li>
                                    </ul>
                                </div>
